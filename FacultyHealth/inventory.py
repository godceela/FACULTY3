...
prodCodeEnt = Entry(medicinePan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
...
medNameEnt = Entry(medicinePan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
...
descEnt = Entry(medicinePan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
...
quantEnt = Entry(medicinePan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
...
eqpEnt = Entry(equipPan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
...
eqQuantEnt = Entry(equipPan, font=("Microsoft JhengHei", 11), 
                        fg="#497687", width=30)
